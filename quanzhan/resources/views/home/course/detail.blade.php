...
<!-- 页面头部 -->
    ...
    <link rel="stylesheet" href="{{asset('homes')}}/css/page-learing-list.css" />
<!--头部导航-->
<header>
...
<div class="container">
    <div class="table-responsive learing-list">
        <table class="table">
            ...
            <tr>
                <td class="btn-group" width="40%">专业：{{$course->profession->profession_name}}</td>
                <td class="btn-group" width="*">描述：{{$course->course_desc}}</td>
            </tr>
            <tr>
                <td class="btn-group" width="40%"></td>
                <td class="btn-group" width="*">
                    <a href="{{url('cart/add/'.$course->id)}}" class="btn btn-primary">加入购物车</a></td>
            </tr>
        </table>
    </div>
</div>
            ...
            <div class="list-cont-left">
                ...
                <div class="tab-content">
                    <div class="content-list">
                                                ...
                                                <li class="">
                            <img src="{{asset('homes')}}/img/201706090930185939fa2acd1a8.jpg" alt="AA">
                            <div class="tit">jQuery选择器的使用 <span>高</span></div>
                            <div>匡霞|史瑞|褚翼</div>
                            <div><a href="" target="_blank">查看详细</a></div>
                        </li>
                                                <li class="">
                            <img src="{{asset('homes')}}/img/201706090936055939fb8503fad.jpg" alt="AA">
                            <div class="tit">jQuery中事件的应用 <span>高</span></div>
                            <div>尤瑶|欧桂花</div>
                            <div><a href="" target="_blank">查看详细</a></div>
                        </li>
                                                <li class="">
                            <img src="{{asset('homes')}}/img/201706090937005939fbbcaf9c0.jpg" alt="AA">
        ...
        <div class="col-lg-3 list-row-rit">
            <div class="list-cont-right">
                <div class="right-box">
                    ...
                    <div class="contList">
                        <li>
                            <img src="{{asset('homes')}}/img/widget-1.png" alt="">
                            <p>程序设计语言</p>
                            <p>评分7.4</p>
                        </li>
                        <li>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div>
                        ...
                        <img src="{{asset('homes')}}/img/asset-logoIco.png" alt=""></div>
