...
<div class="container">
    <div class="learing-pay">
        ...
        <div class="pay-list">
            <div class="row">
                <div class="col-lg-2"><img src="{{asset('homes')}}/img/20170609100236593a01bc1fd9a.jpg" alt=""></div>
                <div class="col-lg-9">
                ...
                <p>
                    ...
                    <a href="{{url('cart/index')}}" class="btn btn-primary" style="display:inline;">去购物车结算</a>
                </p>
            </div>
        </div>
