    ...
    <div class="container" style="background: #fff;">
        ...
        <div class="personal-content pull-right">
            <div class="personal-cont">
                ...
                <div class="my-course">
                    <div class="tit"><span class="active hv-poin">我加入的直播课程</span><span class="nv-poin">我的直播课程</span></div>
                    <div class="cont">
                    @foreach($livecourse as $v)
                        <div class="col-lg-6">
                            <div class="item">
                                <div class="imgIco"><img src="{{asset('homes')}}/img/widget-timg.jpeg" width="50" height="50" alt=""></div>
                                <div class="title">{{$v->live_name}}</div>
                                <div class="about">开始日期：{{date('Y-m-d H:i:s',$v->start_time)}}</div>
                                <div class="time">结束日期: {{date('Y-m-d H:i:s',$v->end_time)}}</div>
                                <div class="rate">
                                    <li class="active"></li>
                                    <li></li>
                                    <li></li>
                                ...
                                @if($v->access==1)
                                <a href="{{url('person/video/play/'.$v->stream_id)}}" class="btn btn-primary">进入直播间</a>
                                @else
                                <a href="#" class="btn btn-primary" disabled='disabled' >未开始或已结束</a>
                                @endif
