                        ...
                        {{$loop->iteration}}.{{$v->question_name}}？（{{$v->question_score}}）分
                                ...
                                不错
                                                这个题你答【对】了 +{{$v->answer->answer_score}} 分<span class="pull-right"><div class="star"><div class="score" style="width: 31.4px;"><i>4</i></div></div></span> </div>
                                                   @else
                                                    <div class="problem-tit error">
                                                        <i class="">X</i>很遗憾 这个题你答【错】了 +{{$v->answer->answer_score}} 分<span class="pull-right"><div class="star"><div class="score" style="width: 31.4px;"><i>4</i></div></div></span></div>
                                                   @endif
