...
<head>
    ...
    <link rel="stylesheet" href="{{asset('homes')}}/css/page-learing-course-video.css" />
    ...
    <script type="text/javascript" src="{{asset('homes')}}/ckplayer/ckplayer.js" charset="utf-8"></script>
</head>
...
<body>
    ...
    <div class="learing-course">
        <div>
            <!--<link rel="import" href="{{asset('homes')}}/{{asset('homes')}}/modules/ui-modules/learing-course-weeklist/learing-course-weeklist.html?__inline">-->
            <div class="course-cont">
                <div class="course-cont-top-video" style="position: relative;height:500px;">
                    ...
                    <div class="video-box" style='width:986px;'>
                        ...
                        <div id="show_video" class="video text-center" style='width:900px;height:450px;background-color:pink;clear:both;margin:auto;'>
                        </div>
                    </div>
                </div>
...
//载入播放器设置参数；如下里面的'show_video'是表示把播放器嵌入到id=show_video的元素里面。  
CKobject.embedSWF('/homes/ckplayer/ckplayer.swf', 'show_video', '在线直播', '600', '400', flashvars,params);
