...
<head>
    ...
    <link rel="stylesheet" href="{{asset('homes')}}/css/page-learing-sign.css" />
</head>
    ...
    <div class="register">
        ...
        <div class="register-body">
            <div class="register-cent">
                <img src="{{asset('homes')}}/img/asset-login_img.jpg" alt="" class="register-ico">
                <form class="required-validate" id="regStudentForm" action="{{url('login_check')}}" method="post">
                        ...
                        <li>
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <span style="margin: 5;color: red">{{$errors->first('username')}}</span>
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="form-group">
                                ...
                                <div class="">
                                    ...
                                    <span style="margin: 5;color: red">{{$errors->first('password')}}</span>
                                    <span style="margin: 5;color: red">{{$errors->first('msg')}}</span>
                                </div>
                            </div>
                        </li>
                        <li>
