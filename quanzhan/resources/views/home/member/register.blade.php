...
<head>
    ...
    <link rel="stylesheet" href="{{asset('homes')}}/css/page-learing-student-register.css" />
</head>
    ...
    <div class="register">
        <div class="register-head">
            <div class="wrap">
                ...
                <div class="gologin">我有账号 去<a href="/login">登录</a></div>
            </div>
        </div>
        <div class="register-body">
            <img src="{{asset('homes')}}/img/page-register_img.jpg" alt="" class="register-ico" width="460">
        ...
        <script src="{{asset('homes')}}/js/page-learing-student-register.js"></script>
<script>
