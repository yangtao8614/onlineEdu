...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  placeholder="" id="option_a" name="option_a">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>选项B：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  placeholder="" id="option_b" name="option_b">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>选项C：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  placeholder="" id="option_c" name="option_c">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>选项D：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text"  placeholder="" id="option_d" name="option_d">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>正确答案：</label>
		<div class="formControls col-xs-8 col-sm-9">
			A:<input type="checkbox" value="1"  placeholder=""  name="question_answer[]">&nbsp;&nbsp;
			B:<input type="checkbox" value="2"  placeholder=""  name="question_answer[]">&nbsp;&nbsp;
			C:<input type="checkbox" value="4"  placeholder=""  name="question_answer[]">&nbsp;&nbsp;
			D:<input type="checkbox" value="8"  placeholder=""  name="question_answer[]">
		</div>
	</div>
	<div class="row cl">
