...
<aside class="Hui-aside">
	...
	@foreach($privA as $a)
		<dl id="menu-article">
			<dt><i class="Hui-iconfont">&#xe616;</i> {{$a->priv_name}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i></dt>
			<dd>
				<ul>
					@foreach($privB as $b)
						@if($b->parent_id==$a->id)
					<li><a data-href="{{url($b->address)}}" data-title="{{$b->priv_name}}" href="javascript:void(0)">{{$b->priv_name}}</a></li>
						@endif
					@endforeach
			</ul>
		</dd>
