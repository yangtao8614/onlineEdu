...
<header class="navbar-wrapper">
    <div class="navbar navbar-fixed-top">
        <div class="container-fluid cl"><a class="logo navbar-logo f-l mr-10 hidden-xs" href="/aboutHui.shtml">学成网后台</a>
            <a class="logo navbar-logo-m f-l mr-10 visible-xs" href="/admin/index">H-ui</a>
...
<aside class="Hui-aside">
    <div class="menu_dropdown bk_2">
        @foreach($privA as $a)
            <dl id="menu-article">
                <dt><i class="Hui-iconfont">&#xe616;</i> {{$a->priv_name}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
                </dt>
                <dd>
                    <ul>
                        @foreach($privB as $b)
                            @if($b->parent_id==$a->id)
                                <li><a data-href="{{url($b->address)}}" data-title="{{$b->priv_name}}"
                                       href="javascript:void(0)">{{$b->priv_name}}</a></li>
                            @endif
                        @endforeach
                    </ul>
                </dd>
