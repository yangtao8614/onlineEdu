...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="live_name" name="live_name">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input class="datainp wicon" id="date01" name="start_time" type="text"  readonly>
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>结束时间：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input class="datainp wicon" id="date02" name="end_time" type="text"  readonly>
		</div>
	</div>
	<div class="row cl">
	...
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3">直播课程描述：</label>
		<div class="formControls col-xs-8 col-sm-9">
