...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off"  value="{{$lesson->lesson_length}}"  id="lesson_length" name="lesson_length">
		</div>
	</div>
	<div class="row cl">
		<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>讲师名称：</label>
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" value="{{$lesson->teacher_name}}"   id="teacher_name" name="teacher_name">
		</div>
	</div>
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
				...
				<input type="text" readonly="readonly" class="input-text" value="{{$lesson->cover_img}}"  id="cover_img" name="cover_img">
				<div id="a">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
				<!--用于显示上传成功后的图片-->
				<input type="text" readonly="readonly" value="{{$lesson->video_address}}" class="input-text"  id="video_address" name="video_address">
				<div id="a2">
					<div class="b" style="width: 750px;">
						<span class="sr-only" style="width: 0%"></span>
					</div>
