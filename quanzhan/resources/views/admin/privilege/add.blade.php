...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="priv_name" name="priv_name">
		</div>
	</div>
	{{csrf_field()}}
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"> <span class="select-box" style="width:150px;">
			<select class="select" name="parent_id" size="1">
				...
				@foreach($priv as $v)
				<option value="{{$v['id']}}">{{str_repeat('--',$v['level_name'])}}{{$v['priv_name']}}</option>
				@endforeach
			</select>
			</span> </div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" value="" placeholder="" id="level_name" name="level_name">
		</div>
	</div>
	<div class="row cl">
