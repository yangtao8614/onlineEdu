...
<div class="page-container">
	...
	<div class="cl pd-5 bg-1 bk-gray mt-20"> <span class="l"><a href="javascript:;" onclick="datadel()" class="btn btn-danger radius"><i class="Hui-iconfont">&#xe6e2;</i> 批量删除</a> <a href="javascript:;" onclick="privilege_add()" class="btn btn-primary radius"><i class="Hui-iconfont">&#xe600;</i> 添加权限</a></span> <span class="r">共有数据：<strong>54</strong> 条</span> </div>
	<table class="table table-border table-bordered table-bg">
		<thead>
			...
			<tr class="text-c">
				...
				<th width="30">ID</th>
				<th width="150" style="text-align: left;">权限名称</th>
				<th width="90">控制器名称</th>
		...
		@foreach($priv as $v)
			<tr class="text-c">
				...
				<td>{{$v['id']}}</td>
				<td style="text-align: left;">{{str_repeat('--',$v['level_name'])}}{{$v['priv_name']}}</td>
...
function privilege_add(){
	layer_show('添加权限','{{url("admin/privilege/add")}}');
}
/*管理员-删除*/
